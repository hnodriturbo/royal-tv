...
const ConversationDetailsPage = () => {
  ...
  const fetchConversationDetails = async () => {
    try {
      ...
      const response = await axiosInstance.get(`/api/admin/conversations/${conversation_id}`);
      ...
      <div className="container-style">
        ...
        {userConversations.length > 1 && (
          <div className="flex flex-col items-center">
            <div className="container-style mt-5 w-10/12 mobile:w-full">
              <h1 className="text-xl font-bold mt-2 text-center">Conversations List:</h1>
                      ...
                      >
                        <div className="flex flex-col items-center">
                          <span className="text-white font-semibold">
                            <strong>Conversation:</strong> {conv.subject || 'No Subject'}
                          </span>
        ...
        <div className="flex flex-col items-center">
          <div className="container-style border p-2 my-5 relative min-h-20 max-h-[600px] flex flex-col w-10/12 mobile:w-full">
            ...
            <div className="overflow-y-auto flex flex-col gap-4 h-full" ref={messagesContainerRef}>
              {!messages?.length ? (
                    ...
                    >
                      <div>
                        ...
                        {!msg.readAt && !msg.sender_is_admin && (
                          <span className="text-green-500 font-bold text-md">● New Message</span>
                        )}

                        {/* ✅ Edited status clearly indicated */}
                        {msg.status === 'edited' && (
                          <span className="text-yellow-300 font-semibold">(edited)</span>
                        )}
                      </div>
