  ...
  return (
    <div className="flex flex-col items-center w-full">
      <div className="container-style">
        ...
        {/* 🖥️ Desktop table */}
        <div className="overflow-x-auto lg:block mobile:hidden">
              ...
              {isLoading ? (
                ...
                conversations.map((c) => (
                  <tr key={c.conversation_id} className="hover:bg-gray-400">
                    ...
                    <td className="border px-4 py-2 max-w-xs truncate">{c.subject || '—'}</td>
                    ...
                    <td className="border px-4 py-2">
                      {c.messagesCount > 0 ? (
                        <span className="text-green-500 font-bold">● {c.messagesCount}</span>
                      ) : (
                        0
                      )}
                    </td>
                    <td className="border px-4 py-2">
                      <button
                        onClick={() => router.push(`/admin/liveChat/${c.conversation_id}`)}
        ...
        {/* 📱 Mobile cards */}
        <div className="mobile:flex lg:hidden flex-col gap-4 mt-6">
          {conversations.map((c) => (
            <div
            ...
            >
              ...
              <p>
                <strong>Unread:</strong> {c.messagesCount > 0 ? `● ${c.messagesCount}` : 0}
              </p>
              <button
                onClick={() => router.push(`/admin/liveChat/${c.conversation_id}`)}
