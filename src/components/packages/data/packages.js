...
'app.packages.grid.feature_full_hd',
'app.packages.grid.feature_premium',
'app.packages.grid.feature_20000',
'app.packages.grid.feature_icelandic',
'app.packages.grid.feature_vpn_addon',
'app.packages.grid.feature_adult_addon'];
...
function PackageCard({ pkg, authenticated, t }) {const __locale = useLocale();
