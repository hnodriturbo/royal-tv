  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full mx-auto mt-20">
        {/* ✅ Thank you banner */}
        {/*         {showThankYou && (
          <div className="p-6 mb-6 text-3xl font-semibold text-center container-style pc:w-8/12 mobile:w-11/12">
            <p>
        ...
        <div className="p-6 text-center container-style pc:w-8/12 mobile:w-11/12">
