  ...
  return (
    <div className="flex flex-col items-center justify-center w-full">
      <div className="container-style">
        ...
        {/* Desktop Table */}
        <div className="overflow-x-auto w-full pc:block mobile:hidden text-lg">
        ...
        {/* Mobile Cards */}
        <div className="mobile:flex pc:hidden flex-col gap-4 mt-4">
          {users.map((user) => (
            <div
              key={user.user_id}
