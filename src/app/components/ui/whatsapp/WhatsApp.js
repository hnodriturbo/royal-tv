...
export default function WhatsAppLogo() {
  return (
    <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="">
      <BsWhatsapp className="w-20 h-20 z-50 fixed bottom-6 right-6 bg-green-500 flex items-center justify-center rounded-full shadow-lg hover:bg-green-600 transition duration-300" />
    </a>
  );
}
