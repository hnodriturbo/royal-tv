      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <div className="container-style mb-4">
          ...
          <h3 className="text-xl font-bold mb-4">
            Where you can watch over 20.000 tv stations
          </h3>
          ...
          <p className="mb-6">
            Experience high-quality streaming with our diverse IPTV packages.
            Choose the plan that best fits your needs and enjoy uninterrupted
            entertainment. Register now for exclusive deals and personalized
            support!
          </p>
          <Link href="/auth/signup">
            <button className=" bg-blue-500 py-2 px-4 rounded-lg hover:bg-blue-600 transition whitespace-nowrap overflow-hidden text-ellipsis text-center">
        ...
        <div className="w-full flex flex-col items-center justify-center">
          <div className="container-style mb-4">
            <ul className="list-disc list-inside space-y-4">
              ...
              <li className="text-lg font-semibold">
                Request your free trial. We’ll process your trial request
                automatically.
              </li>
              <li className="text-lg font-semibold">
                Check your email. Within 24 hours you’ll receive subscription
                details.
              </li>
              ...
              <div className="mt-6">
                ...
                <div className="w-full flex pc:flex-row mobile:flex-col gap-8 text-lg">
                  {/* Smart TV column */}
                  <div className="flex-1 flex pc:flex-row mobile:flex-col items-start mobile:items-center gap-4">
              ...
              <h2 className="text-lg font-semibold">
                Watch for notifications. When your dashboard message arrives,
                you’ll get an email — and again when your subscription is
                active.
              </h2>
            </ul>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 w-8/12 mobile:w-11/12 mb-4">
          {packages.map((pkg) => (
            <div
              key={pkg.id}
              className="w-full md:w-[48%] flex justify-center items-stretch"
            >
        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="container-style">
            ...
            <p className="mb-4">
              ...
              with your subscription or trial. Once we’re in contact, the
              process is quick and easy. After completing your purchase, we’ll
            ...
            <p className="mb-4">
              ...
              Firestick, and Android TV) and{' '}
              <strong>Smarters Player Lite</strong> (compatible with iOS,
              Android, Firestick, Windows, and macOS).
            </p>
          </div>
        </div>
      </div>
