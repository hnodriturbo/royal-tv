...
export default function AdminLiveChatMain() {
  ...
  const handleDeleteAll = (userId) =>
    openModal('deleteAllConvos', {
      ...
      description: 'This deletes every live‑chat conversation for this user. Continue?',
    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="container-style">
        ...
        {!isLoading && conversations.length === 0 && (
          <p className="text-center text-white mb-4">No users with conversations found.</p>
        )}
            ...
            >
              ...
              <p>
                ...
                {c.unreadConversationsForUser > 0 ? (
                  <span className="text-green-400 font-bold">● {c.unreadConversationsForUser}</span>
                ) : (
                  0
                )}
              </p>
              ...
              <p>
                <strong>Status:</strong> {isUserOnline(c.user.user_id) ? '🟢 Online' : '⚪ Offline'}
              </p>
