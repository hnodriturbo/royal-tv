    ...
    openModal('DeleteConversation', {
      ...
      onConfirm: async () => {
        try {
          ...
          const { deleted } = await axiosInstance.delete('/api/admin/deleteConversation', {
            params: {
      ...
      <div className="container-style">
        ...
        <div className="flex flex-col items-center">
          <div className="container-style mt-5 w-10/12 mobile:w-full">
            <h2 className="text-lg font-bold text-center mb-2">👥 Users in This Conversation</h2>
                ...
                <div className="flex flex-row justify-start items-center gap-3">
                  {otherConvos.map((conv) => (
                    <button
                      ...
                      onClick={() =>
                        router.replace(`/admin/liveChat/${conv.conversation_id}`, undefined, {
                          shallow: true
                        })
                      }
